  ...
  return (
    ...
    >
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <h3 className="text-green-400 text-sm sm:text-base  mb-6 sm:mt-32 mt-16  font-bold">
          ¡Comienza Hoy con Tu Sitio Web!
          </h3>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-primaryText  px-8 sm:px-8 md:px-20 lg:px-4">
            <h1 className="">
              Tu Sitio Web a medida para Tu Negocio
            </h1>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <h2 className="text-secondaryText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-48 ">
            Consulta por el plan que mejor se adapte a tus necesidades
          </h2>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
        ...
        >
          <div className="flex flex-col gap-2 sm:flex-row mt-14 mb-24 sm:mb-40 justify-center">
            ...
            >
              <a href="https://wa.me/+542804658107?text=Hola, estoy interesado en tus servicios. ¿Podrias darme más información?">Consultar</a>
            </button>
        ...
        >
          <div className="relative w-screen flex justify-center ">
            <img
              ...
              className="w-4/5 2xl:w-[700px] mx-auto absolute z-10  lg:top-6 xl:top-0"
            />
          </div>
        </motion.div>
        <div className="relative w-screen flex justify-center ">
